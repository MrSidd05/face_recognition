...
# imgSid = face_recognition.load_image_file(r'C:\Users\siddh\Desktop\major_project\ImagesBasics\Sidd.jpg')
# imgSid = cv2.cvtColor(imgSid,cv2.COLOR_BGR2RGB)

# imgTest = face_recognition.load_image_file(r'C:\Users\siddh\Desktop\major_project\ImagesBasics\Sidd_test.jpg')
# imgTest = cv2.cvtColor(imgTest,cv2.COLOR_BGR2RGB)

imgSid = face_recognition.load_image_file(r'C:\Users\siddh\Desktop\major_project\ImagesBasics\Sidd.jpg')
imgSid = cv2.cvtColor(imgSid,cv2.COLOR_BGR2RGB)

imgTest = face_recognition.load_image_file(r'C:\Users\siddh\Desktop\major_project\ImagesBasics\kartik_test.jpg')
imgTest = cv2.cvtColor(imgTest,cv2.COLOR_BGR2RGB)
